...
| gdbBreakpointType | string | Launch | The type of breakpoint to direct the GDB server to use. This setting affects all breakpoints generated and is intended for use only in cases where the default automatic behaviour fails. |
