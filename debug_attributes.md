...
| Attribute | Type | Launch or Attach | Description |
| --------- | ---- | ---------------- | ----------- |
...
| servertype | string | Both | GDB Server type - supported types are jlink, openocd, pyocd, pe, stlink, stutil, qemu, bmp and external |
