...
class ACTIONS {
    static cursorUp(n=1)       { return n > 0 ? CSI + n.toString() + 'A' : ''; }
    static cursorDown(n=1)     { return n > 0 ? CSI + n.toString() + 'B' : ''; }
    static cursorForward(n=1)  { return n > 0 ? CSI + n.toString() + 'C' : ''; }
    static cursorBack(n=1)     { return n > 0 ? CSI + n.toString() + 'D' : ''; }
    static clearAll()          { return CSI + '2J' + CSI + '3J' + CSI + ';H'; }  // Kill entire buffer and set cursor postion to 1,1
    static clearScreen()       { return CSI + '2J' + CSI + ';H'; }               // Kill the visible part of the screen
    ...
    static killLine(n=0)       { return ACTIONS.cursorBack(n) + ACTIONS.killLineForward(); }
    static killEntireLine()    { return CSI + '2K'; }
};
...
export class PtyTerminal extends EventEmitter {
    ...
    */
    ...
    protected doPrompt() {
        ...
        PtyTerminal.lastStack = Error().stack;
    }
