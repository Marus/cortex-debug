 ...
 */
export declare function getDisplayedNodes(rootNode: HTMLElement | null | undefined, selector: string | null | undefined): HTMLElement[] | void;
/**
 ...
 */
export declare function getKeyCode(event: KeyboardEvent | null): number | null;
