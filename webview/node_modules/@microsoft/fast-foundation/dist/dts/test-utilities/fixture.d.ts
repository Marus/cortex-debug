...
import type { FoundationElementDefinition, FoundationElementRegistry } from "../foundation-element/foundation-element";
/**
 ...
 * ensure that the DOM has settled.
 */
export declare function fixture<TElement = HTMLElement>(templateNameOrRegistry: ViewTemplate | string | FoundationElementRegistry<FoundationElementDefinition, Constructable<TElement>> | [FoundationElementRegistry<FoundationElementDefinition, Constructable<TElement>>, ...FoundationElementRegistry<FoundationElementDefinition, Constructable>[]], options?: FixtureOptions): Promise<Fixture<TElement>>;
